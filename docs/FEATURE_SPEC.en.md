...
> Written: 2026-09-02 · Updated: 2026-09-07 · Status: draft
...
| `POST /api/try` | Server-side Try-it-out proxy (`docs:try`) |
...
| **v0.3** | planned | OIDC / OAuth2 adapter |
